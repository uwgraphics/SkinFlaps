...
#ifndef SUBROUTINE_Matrix_Times_Matrix
#include <assert.h>
...
#ifdef SUBROUTINE_Matrix_Times_Matrix
__forceinline
#endif
void Matrix_Times_Matrix(const T_DATA (&A)[9], const T_DATA (&B)[9], T_DATA (&C)[9])
{
...
#ifndef SUBROUTINE_Matrix_Times_Matrix
#define INSTANCE_KERNEL_Matrix_Times_Matrix(WIDTH,TYPE) const WIDETYPE(TYPE,WIDTH) (&A)[9], const WIDETYPE(TYPE,WIDTH) (&B)[9], WIDETYPE(TYPE,WIDTH) (&C)[9]
INSTANCE_KERNEL(Matrix_Times_Matrix);
#undef INSTANCE_KERNEL_Matrix_Times_Matrix
#else
}
#endif
