...
template void Matrix_Times_Transpose_Reference(const double A[9], const double B[9], double C[9]);
template bool Matrix_Times_Transpose_Compare(const double C[9], const double C_reference[9]);
