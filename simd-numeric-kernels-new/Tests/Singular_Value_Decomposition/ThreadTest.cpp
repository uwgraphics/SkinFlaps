    ...
    for (int chunk_offset = 0; chunk_offset < 16; chunk_offset += ChunkSize)
      {
        ...
        Singular_Value_Decomposition < SIMDArchitectureScalar<float>, float[16] > (Ak, Uk, Sk,
                                                                    Vk);
      }
    ...
    for (int chunk_offset = 0; chunk_offset < 16; chunk_offset += ChunkSize)
      {
        ...
        Singular_Value_Decomposition < SIMDArchitectureAVX2<float>, float[16] > (Ak, Uk, Sk,
                                                                     Vk);
      }
    ...
    for (int chunk_offset = 0; chunk_offset < 16; chunk_offset += ChunkSize)
      {
        ...
        Singular_Value_Decomposition < SIMDArchitectureAVX512<float>, float[16] > (Ak, Uk, Sk,
                                                                     Vk);
      }
