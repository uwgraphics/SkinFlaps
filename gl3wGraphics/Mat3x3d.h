...
/*
    ...
    {return Vec3d(x[0]*v._v[0]+x[3]*v._v[1]+x[6]*v._v[2],x[1]*v._v[0]+x[4]*v._v[1]+x[7]*v._v[2],x[2]*v._v[0]+x[5]*v._v[1]+x[8]*v._v[2]);}
...
/*    static Mat3x3d<T> Translation_Matrix(const VECTOR_2D<T>& translation) // treating the 3x3 matrix as a homogeneous transformation on 2d vectors
	...
	return Mat3x3d(axis._v[0]*axis._v[0]+(1-axis._v[0]*axis._v[0])*c,axis._v[0]*axis._v[1]*(1-c)+axis._v[2]*s,axis._v[0]*axis._v[2]*(1-c)-axis._v[1]*s,
...
/*    static Mat3x3d<T> Rotation_Matrix(const VECTOR_3D<T>& rotation)
    ...
    {return Mat3x3d(u._v[0]*v._v[0],u._v[1]*v._v[0],u._v[2]*v._v[0],u._v[0]*v._v[1],u._v[1]*v._v[1],u._v[2]*v._v[1],u._v[0]*v._v[2],u._v[1]*v._v[2],u._v[2]*v._v[2]);}
...
{return Vec3d(v._v[0]*A.x[0]+v._v[1]*A.x[1]+v._v[2]*A.x[2],v._v[0]*A.x[3]+v._v[1]*A.x[4]+v._v[2]*A.x[5],v._v[0]*A.x[6]+v._v[1]*A.x[7]+v._v[2]*A.x[8]);}
