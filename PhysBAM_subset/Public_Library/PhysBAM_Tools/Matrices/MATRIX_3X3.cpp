//#####################################################################
// Copyright 2002-2014, Silvia Salinas-Blemker, Robert Bridson, Ronald Fedkiw, Eran Guendelman, Geoffrey Irving, Neil Molino, Igor Neverov, Craig Schroeder, Rahul Sheth, Joseph Teran.
...
//#####################################################################
// Function Fast_Reverse_Polar_Decomposition
//#####################################################################
template<class T> void MATRIX<T,3>::
Fast_Reverse_Polar_Decomposition(SYMMETRIC_MATRIX<T,3>& S,MATRIX<T,3>& Q) const
{
    MATRIX<T,3> U,V;DIAGONAL_MATRIX<T,3> D;Fast_Singular_Value_Decomposition(U,D,V);
    Q=U.Times_Transpose(V);S=SYMMETRIC_MATRIX<T,3>::Conjugate(U,D);
}
//#####################################################################
