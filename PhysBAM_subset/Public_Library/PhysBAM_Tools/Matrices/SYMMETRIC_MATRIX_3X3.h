//#####################################################################
// Copyright 2003-2013, Ronald Fedkiw, Geoffrey Irving, Rahul Sheth, Joseph Teran.
...
public:
    ...
    {x11=x21=x31=x22=x32=x33=0;}

    inline void Set_Identity_Matrix()
    {x11=x22=x33=1;x21=x31=x32=0;}
    ...
    SYMMETRIC_MATRIX& operator=(const T a)
    {x11=x21=x31=x22=x32=x33=a;return *this;}
