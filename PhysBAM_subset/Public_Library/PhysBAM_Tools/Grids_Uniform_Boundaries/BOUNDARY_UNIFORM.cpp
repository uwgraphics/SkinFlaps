...
Fill_Ghost_Cells(const T_GRID& grid,const T_ARRAYS_T2& u,T_ARRAYS_T2& u_ghost,const T dt,const T time,const int number_of_ghost_cells)
{
    ...
    for(int side=1;side<=T_GRID::number_of_faces_per_cell;side++)Fill_Single_Ghost_Region(grid,u_ghost,side,dt,time,regions(side));
}
//#####################################################################
...
//#####################################################################
template<class T_GRID,class T2> void BOUNDARY_UNIFORM<T_GRID,T2>::
Fill_Single_Ghost_Region_Threaded(RANGE<TV_INT>& region,const T_GRID& grid,T_ARRAYS_T2& u_ghost,const int side,const T dt,const T time)
{
    Fill_Single_Ghost_Region(grid,u_ghost,side,dt,time,region);
}
//#####################################################################
// Function Fill_Single_Ghost_Region
//#####################################################################
template<class T_GRID,class T2> void BOUNDARY_UNIFORM<T_GRID,T2>::
Fill_Single_Ghost_Region(const T_GRID& grid,T_ARRAYS_T2& u_ghost,const int side,const T dt,const T time,const RANGE<TV_INT>& region) const
{
...
template class BOUNDARY_UNIFORM<GRID<VECTOR<float,1> >,int>;
...
template class BOUNDARY_UNIFORM<GRID<VECTOR<float,1> >,VECTOR<float,5> >;
template class BOUNDARY_UNIFORM<GRID<VECTOR<float,2> >,float>;
template class BOUNDARY_UNIFORM<GRID<VECTOR<float,2> >,int>;
template class BOUNDARY_UNIFORM<GRID<VECTOR<float,2> >,VECTOR<float,1> >;
...
template class BOUNDARY_UNIFORM<GRID<VECTOR<float,3> >,int>;
template class BOUNDARY_UNIFORM<GRID<VECTOR<float,3> >,VECTOR<float,1> >;
template class BOUNDARY_UNIFORM<GRID<VECTOR<float,3> >,VECTOR<float,2> >;
template class BOUNDARY_UNIFORM<GRID<VECTOR<float,3> >,VECTOR<float,3> >;
template class BOUNDARY_UNIFORM<GRID<VECTOR<float,3> >,VECTOR<float,4> >;
...
template class BOUNDARY_UNIFORM<GRID<VECTOR<double,1> >,int>;
...
template class BOUNDARY_UNIFORM<GRID<VECTOR<double,1> >,VECTOR<double,5> >;
template class BOUNDARY_UNIFORM<GRID<VECTOR<double,2> >,double>;
template class BOUNDARY_UNIFORM<GRID<VECTOR<double,2> >,int>;
template class BOUNDARY_UNIFORM<GRID<VECTOR<double,2> >,VECTOR<double,1> >;
...
template class BOUNDARY_UNIFORM<GRID<VECTOR<double,3> >,int>;
template class BOUNDARY_UNIFORM<GRID<VECTOR<double,3> >,VECTOR<double,1> >;
template class BOUNDARY_UNIFORM<GRID<VECTOR<double,3> >,VECTOR<double,2> >;
template class BOUNDARY_UNIFORM<GRID<VECTOR<double,3> >,VECTOR<double,3> >;
template class BOUNDARY_UNIFORM<GRID<VECTOR<double,3> >,VECTOR<double,4> >;
