...
Fast_Marching_Method(const int local_advection_spatial_order,const T time,const ARRAY<TV_INT>* seed_indices,const bool add_extra_fixed_seed_indices,const bool update_ghost_cells)
{
    T_LEVELSET::Fast_Marching_Method(time,half_band_width+grid.dX.Max()*(1+min(3,local_advection_spatial_order)),seed_indices,false,add_extra_fixed_seed_indices,update_ghost_cells);
