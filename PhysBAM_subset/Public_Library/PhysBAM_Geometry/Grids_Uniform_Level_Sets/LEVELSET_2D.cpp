...
// Function Hessian
//#####################################################################
template<class T_GRID_input> SYMMETRIC_MATRIX<typename T_GRID_input::SCALAR,2> LEVELSET_2D<T_GRID_input>::
...
//#####################################################################
template<class T_GRID_input> VECTOR<typename T_GRID_input::SCALAR,1> LEVELSET_2D<T_GRID_input>::
...
//#####################################################################
template<class T_GRID> void LEVELSET_2D<T_GRID>::
Fast_Marching_Method(const T time,const T stopping_distance,const ARRAY<VECTOR<int,2> >* seed_indices,const bool add_seed_indices_for_ghost_cells,const bool add_extra_fixed_seed_indices,const bool update_ghost_cells)
{       
...
//#####################################################################
template<class T_GRID> void LEVELSET_2D<T_GRID>::
Get_Signed_Distance_Using_FMM(ARRAY<T,VECTOR<int,2> >& signed_distance,const T time,const T stopping_distance,const ARRAY<VECTOR<int,2> >* seed_indices,const bool add_seed_indices_for_ghost_cells,const bool add_extra_fixed_seed_indices,const bool update_ghost_cells)
{       
