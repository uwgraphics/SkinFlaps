...
// Function Hessian
//#####################################################################
template<class T_GRID_input> SYMMETRIC_MATRIX<typename T_GRID_input::SCALAR,3> LEVELSET_3D<T_GRID_input>::
...
//#####################################################################
template<class T_GRID_input> VECTOR<typename T_GRID_input::SCALAR,2> LEVELSET_3D<T_GRID_input>::
...
//#####################################################################
template<class T_GRID> void LEVELSET_3D<T_GRID>::
Fast_Marching_Method(const T time,const T stopping_distance,const ARRAY<VECTOR<int,3> >* seed_indices,const bool add_seed_indices_for_ghost_cells,const bool add_extra_fixed_seed_indices,const bool update_ghost_cells)
{
    Get_Signed_Distance_Using_FMM(phi,time,stopping_distance,seed_indices,add_seed_indices_for_ghost_cells,add_extra_fixed_seed_indices,update_ghost_cells);
}
//#####################################################################
// Function Fast_Marching_Method
//#####################################################################
...
//#####################################################################
template<class T_GRID> void LEVELSET_3D<T_GRID>::
Get_Signed_Distance_Using_FMM(ARRAY<T,TV_INT>& signed_distance,const T time,const T stopping_distance,const ARRAY<VECTOR<int,3> >* seed_indices,const bool add_seed_indices_for_ghost_cells,const bool add_extra_fixed_seed_indices,const bool update_ghost_cells)
{
    ...
    fmm.Fast_Marching_Method(phi_ghost,stopping_distance,seed_indices,add_seed_indices_for_ghost_cells,add_extra_fixed_seed_indices,update_ghost_cells);
...
// Function Normal
//#####################################################################
template<class T_GRID_input> VECTOR<typename T_GRID_input::SCALAR,3> LEVELSET_3D<T_GRID_input>::
