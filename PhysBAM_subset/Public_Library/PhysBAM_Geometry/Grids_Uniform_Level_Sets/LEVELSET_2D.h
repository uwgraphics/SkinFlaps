...
public:
    ...
    using BASE::grid;using BASE::phi;using BASE::Phi;using BASE::Extended_Phi;using BASE::normals;using BASE::curvature;using BASE::cell_range;
...
public:
    void Fast_Marching_Method(const T time=0,const T stopping_distance=0,const ARRAY<VECTOR<int,2> >* seed_indices=0,const bool add_seed_indices_for_ghost_cells=false,const bool add_extra_fixed_seed_indices=false,const bool update_ghost_cells=false);
    void Get_Signed_Distance_Using_FMM(ARRAY<T,VECTOR<int,2> >& signed_distance,const T time=0,const T stopping_distance=0,const ARRAY<VECTOR<int,2> >* seed_indices=0,const bool add_seed_indices_for_ghost_cells=false,const bool add_extra_fixed_seed_indices=false,const bool update_ghost_cells=false);
