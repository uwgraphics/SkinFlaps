...
public:
    void Fast_Marching_Method(const T time=0,const T stopping_distance=0,const ARRAY<VECTOR<int,1> >* seed_indices=0,const bool add_seed_indices_for_ghost_cells=false,const bool add_extra_fixed_seed_indices=false,const bool update_ghost_cells=false);
