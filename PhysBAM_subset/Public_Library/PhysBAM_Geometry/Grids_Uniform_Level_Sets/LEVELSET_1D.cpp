...
//#####################################################################
template<class T> void LEVELSET_1D<T>::
Fast_Marching_Method(const T time,const T stopping_distance,const ARRAY<VECTOR<int,1> >* seed_indices,const bool add_seed_indices_for_ghost_cells,const bool add_extra_fixed_seed_indices,const bool update_ghost_cells)
{
...
Get_Signed_Distance_Using_FMM(ARRAY<T,VECTOR<int,1> >& signed_distance,const T time,const T stopping_distance,const ARRAY<VECTOR<int,1> >* seed_indices,
    const bool add_seed_indices_for_ghost_cells,const bool add_extra_fixed_seed_indices,const bool update_ghost_cells)
{       
