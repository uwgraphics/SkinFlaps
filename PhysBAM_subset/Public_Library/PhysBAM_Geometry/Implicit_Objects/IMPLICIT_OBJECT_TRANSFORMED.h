...
public:
    ...
    using BASE::box;
    using BASE_HELPER::Name_Helper;using BASE_HELPER::Object_Space_Box;using BASE_HELPER::Object_Space_Length;using BASE_HELPER::Object_Space_Point;
    using BASE_HELPER::Object_Space_Unitless_Vector;using BASE_HELPER::Scale_Transform;using BASE_HELPER::World_Space_Box;
    using BASE_HELPER::World_Space_Point;using BASE_HELPER::World_Space_Length;using BASE_HELPER::World_Space_Length_Hessian;
    using BASE_HELPER::World_Space_Unitless_Vector;using BASE_HELPER::World_Space_Vector;
