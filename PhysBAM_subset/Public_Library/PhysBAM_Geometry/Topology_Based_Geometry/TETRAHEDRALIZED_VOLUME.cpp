...
Barycentric_Interpolate(const VECTOR<T,3>& x,ARRAY_VIEW<T2> values,T2& result,int* index)const
{
...
template bool TETRAHEDRALIZED_VOLUME<float>::Barycentric_Interpolate(const VECTOR<float,3>&,ARRAY_VIEW<float>,float&,int* index)const;
template bool TETRAHEDRALIZED_VOLUME<float>::Barycentric_Interpolate(const VECTOR<float,3>&,ARRAY_VIEW<VECTOR<float,3> >,VECTOR<float,3>&,int* index)const;
#ifndef COMPILE_WITHOUT_DOUBLE_SUPPORT
template class TETRAHEDRALIZED_VOLUME<double>;
template bool TETRAHEDRALIZED_VOLUME<double>::Barycentric_Interpolate(const VECTOR<double,3>&,ARRAY_VIEW<double>,double&,int* index)const;
template bool TETRAHEDRALIZED_VOLUME<double>::Barycentric_Interpolate(const VECTOR<double,3>&,ARRAY_VIEW<VECTOR<double,3> >,VECTOR<double,3>&,int* index)const;
#endif
}
