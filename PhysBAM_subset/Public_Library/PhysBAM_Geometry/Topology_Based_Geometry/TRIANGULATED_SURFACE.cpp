...
//#####################################################################
template<class T> void TRIANGULATED_SURFACE<T>::
Initialize_Conical_Frustum_Mesh_And_Particles(const int m,const int n,const T length,const T radius1,const T radius2,const bool create_caps)
{
    TOPOLOGY_BASED_GEOMETRY_COMPUTATIONS::Initialize_Conical_Frustum_Mesh_And_Particles(*this,m,n,length,radius1,radius2,create_caps);
}
//#####################################################################
