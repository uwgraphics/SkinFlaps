...
// Court modified code of Shen et al. so one triangle is fixed with eval of multiple second triangles.
// use external variables as no namespaces in C.
double V0_Shen[3], V1_Shen[3], V2_Shen[3], N2_Shen[3], d2_Shen;

bool setFixedTriangle_Shen(double V0[3], double V1[3], double V2[3]) {
    for (int i = 0; i < 3; ++i) {
        V0_Shen[i] = V0[i];  V1_Shen[i] = V1[i];  V2_Shen[i] = V2[i];
    }
    ...
    SUB(E2, V2, V0);
    CROSS(N2_Shen, E1, E2);
    if (N2_Shen[0] == 0.0f && N2_Shen[1] == 0.0f && N2_Shen[2] == 0.0f)  // degenerate triangle
        return false;
    d2_Shen = -DOT(N2_Shen, V0);
    return true;
}

int tri_fixedTri_intersect(double U0[3], double U1[3], double U2[3])
{
    double E1[3], E2[3];
    double N1[3], d1;
    double tmp[3];
    ...
    double N[3];
    double tdu0 = 0.0f, tdu1 = 0.0f, tdv0 = 0.0f, tdv1 = 0.0f;
    double du01, du02;
    ...
    double* UU0 = nullptr, * UU1 = nullptr, * UU2 = nullptr, * VV0 = nullptr, * VV1 = nullptr, * VV2 = nullptr;
    ...
    dv0 = DOT(N1, V0_Shen) + d1;
    dv1 = DOT(N1, V1_Shen) + d1;
    dv2 = DOT(N1, V2_Shen) + d1;
    ...
    du0 = DOT(N2_Shen, U0) + d2_Shen;
    du1 = DOT(N2_Shen, U1) + d2_Shen;
    du2 = DOT(N2_Shen, U2) + d2_Shen;
    ...
    if ((dv0 == 0) && (dv1 == 0) && (dv2 == 0))
        return coplanar_tri_tri(N1, V0_Shen, V1_Shen, V2_Shen, U0, U1, U2);
    ...
    {
        VV0 = V0_Shen; VV1 = V1_Shen; VV2 = V2_Shen; tdv0 = dv0; tdv1 = dv1;    /* V0 is single vertex of the plane of triangle (U0,U1,U2) */
    }
    else if (SIGN01_DIF_SIGN2(dv2, dv0, dv1))
    {
        VV0 = V1_Shen; VV1 = V2_Shen; VV2 = V0_Shen; tdv0 = dv1; tdv1 = dv2;    /* V1 is single vertex of the plane of triangle (U0,U1,U2) */
    }
    else if (SIGN01_DIF_SIGN2(dv0, dv1, dv2))
    {
        VV0 = V2_Shen; VV1 = V0_Shen; VV2 = V1_Shen; tdv0 = dv2; tdv1 = dv0;    /* V2 is single vertex of the plane of triangle (U0,U1,U2) */
    }
...
int tri_tri_intersectD(double V0[3], double V1[3], double V2[3],
                      double U0[3],double U1[3],double U2[3])
{
  ...
  // VV0 is the pointer to the single vertex in (V0,V1,V2) of the plane(U0,U1,U2)
  // UU0 is the pointer to the single vertex in (U0,U1,U2) of the plane(V0,V1,V2)
  double *UU0,*UU1,*UU2,*VV0,*VV1,*VV2;
