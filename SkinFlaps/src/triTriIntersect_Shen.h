...
float V0_Shen[3], V1_Shen[3], V2_Shen[3], N2_Shen[3], d2_Shen;

bool setFixedTriangle_Shen(float V0[3], float V1[3], float V2[3]) {
    for (int i = 0; i < 3; ++i) {
...
int tri_fixedTri_intersect(float U0[3], float U1[3], float U2[3])
{
    float E1[3], E2[3];
    float N1[3], d1;
    float tmp[3];
    ...
    float N[3];
    float tdu0 = 0.0f, tdu1 = 0.0f, tdv0 = 0.0f, tdv1 = 0.0f;
    float du01, du02;
    ...
    float* UU0 = nullptr, * UU1 = nullptr, * UU2 = nullptr, * VV0 = nullptr, * VV1 = nullptr, * VV2 = nullptr;
